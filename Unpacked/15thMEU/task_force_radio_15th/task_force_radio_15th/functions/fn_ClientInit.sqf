...
if (isNil "TF_defaultWestBackpack") then {
	TF_defaultWestBackpack = "tf_prc113";
};
...
#include "\task_force_radio_15th\define.h"
...
IDC_RT113G_RADIO_DIALOG_EDIT_ID = IDC_RT113G_EDIT;
IDC_RT113G_RADIO_DIALOG_ID = IDD_RT113G_RADIO_DIALOG;
