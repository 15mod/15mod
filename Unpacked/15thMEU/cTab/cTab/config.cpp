...
// config.bin - 19:56:11 10/04/15, generated in 0.11 seconds
...
class cTab_settings {
	...
	cTab_vehicleClass_has_FBCB2[] = {"DAR_MTVRBase","ExA_RG31_BASE","MRAP_01_base_F","MRAP_02_base_F","MRAP_03_base_F","Wheeled_APC_F","Tank","Truck_01_base_F","Truck_03_base_F"};
...
class CfgVehicles {
	class Box_NATO_WpsSpecial_F;	// External class reference
