private ["_jet", "_hose", "_fuel", "_fuelingText", "_dir", "_fuelspot", "_nimspots", "_msg"];
...
if(_hose select 0 == 1)then{
	...
	_pointHose = _fuelspot selectionPosition "fuelHose1Pos"; //default hose point
	_pointJet = _fuelspot worldToModel [(_fuelPos select 0), (_fuelPos select 1), (_fuelPos select 2)];
	...
	if(!((_jet selectionPosition "pointFuel") select 0 == 0))then{  //only animate hose if plane's fuelPoint exists
		...
		_fuelspot animate["ani_hose1_wide", _dWide];
		_fuelspot animate["ani_hose1_long", _dLong];
		_fuelspot animate["ani_hose1_high", _dHigh];
		_fuelspot animate["ani_hose1B_wide", (_dWide * .75)];
		_fuelspot animate["ani_hose1B_long", (_dLong * .75)];
	};
	...
	_fuelspot animate["ani_hose1_wide", 0];
	_fuelspot animate["ani_hose1_long", 0];
	_fuelspot animate["ani_hose1_high", 0];
	_fuelspot animate["ani_hose1B_wide", 0];
	_fuelspot animate["ani_hose1B_long", 0];
...
if(_hose select 0 == 2)then{
	...
	// nimFuel2Use = 1;
	_fuelPos = (_jet modelToWorld (_jet selectionPosition "pointFuel")); //jet con point
	_pointHose = _fuelspot selectionPosition "fuelHose2Pos"; //default hose point
	_pointJet = _fuelspot worldToModel [(_fuelPos select 0), (_fuelPos select 1), (_fuelPos select 2)];
...
if(!((_jet selectionPosition "pointFuel") select 0 == 0))then{  //only animate hose if plane's fuelPoint exists
		...
		_fuelspot animate["ani_hose2_wide", _dWide];
		_fuelspot animate["ani_hose2_long", _dLong];
		_fuelspot animate["ani_hose2_high", _dHigh];
		_fuelspot animate["ani_hose2B_wide", (_dWide * .75)];
		_fuelspot animate["ani_hose2B_long", (_dLong * .75)];
	};
	...
	_fuelspot animate["ani_hose2_wide", 0];
	_fuelspot animate["ani_hose2_long", 0];
	_fuelspot animate["ani_hose2_high", 0];
	_fuelspot animate["ani_hose2B_wide", 0];
	_fuelspot animate["ani_hose2B_long", 0];
